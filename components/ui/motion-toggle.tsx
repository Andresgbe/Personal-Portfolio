...
export function MotionToggle() {
  ...
  return (
    ...
    >
      ...
      <span className="motion-switch relative h-6 w-11 rounded-full border border-ink/20 transition-colors duration-200">
        <span className="motion-switch-knob absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-ink shadow transition-transform duration-200" />
      </span>
    </button>
  );
}
